...
#ifndef DOUBLESPINUNITRPS_H
#define DOUBLESPINUNITRPS_H

#include "component/using.h"
#include "delegate/styleditemdelegate.h"

class DoubleSpinUnitRPS final : public StyledItemDelegate {
    Q_OBJECT

signals:
    void STransRef(const QModelIndex& index);
